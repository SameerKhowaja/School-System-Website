    ...
    return new Promise((resolve, reject) => {
        ...
        try{
            ...
            .then((doc)=>{
                ...
                // user changed to teachers in line 289
                user.db.collection('teachers').doc(teacher_id).get()
                .then((res)=>{
                    let userData = res.data()
                    userData.resources ? userData.resources = [...userData.resources, ResourceID] : userData.resources =[ResourceID]
                    // user changed to teachers in line 294
                    user.db.collection('teachers').doc(teacher_id).set(userData)
                    .then(() => resolve(ret))
                    .catch((e)=>console.log(e))
                })
                .catch((e) => console.log(e))
